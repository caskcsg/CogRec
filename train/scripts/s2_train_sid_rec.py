...
from config.config import MODEL_DIR, PROC_DIR
...
@dataclass
class DataArguments:
    category: str = field(default="Beauty", metadata={"help": "Category name (Beauty / Sports / Toys)"})
    train_data_path: Optional[str] = field(default=None, metadata={"help": "Training parquet path"})
    val_data_path: Optional[str] = field(default=None, metadata={"help": "Validation parquet path"})
...
if __name__ == "__main__":
    ...
    if data_args.train_data_path is None:
        data_args.train_data_path = str(PROC_DIR / data_args.category / "training_prediction_sid_data_train.parquet")
    if data_args.val_data_path is None:
        data_args.val_data_path = str(PROC_DIR / data_args.category / "training_prediction_sid_data_val.parquet")
